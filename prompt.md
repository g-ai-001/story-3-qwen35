...
- 小说字数必须控制在450万字到500万字, 如果超过500万字则完结小说, 立即退出本次任务
- `gh`命令必须在代码仓目录下执行
- 首个版本号必须从0.1.0开始
...
- **剧情审查 (Review)**：Review 剧情, 故事骨架、关键情节节点、核心主题与隐喻、逻辑性等方面进行改进, 移除不需要的情节, 保持Clean Story。
...
- 极强的商业属性与互动性 (Commercial Viability)：标题要直白、有冲击力，简介要能在 30 秒内讲清核心卖点和最大看点
- 普世价值观的升华 (Universal Values)：探讨人性、正义、爱与牺牲等永恒主题、传递正向的价值观
